...
INSERT IGNORE INTO Departments (Id, Name, Code, CreatedAt) VALUES
...
DELETE FROM Users WHERE Email IN ('admin@university.edu', 'qamanager@university.edu', 'john@university.edu');
